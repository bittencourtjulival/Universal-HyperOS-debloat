...
echo ""
echo "1) SAFE DEBLOAT"
echo "   Removes only safe bloatware"
echo ""
echo "2) EXTREME DEBLOAT"
echo "   Removes almost everything non-essential"
echo ""
echo "3) CUSTOM"
echo "   Select categories manually"
echo ""
...
echo ""
echo -e "${GREEN}Applying SAFE DEBLOAT...${NC}"
...
echo ""
echo -e "${RED}Applying EXTREME DEBLOAT...${NC}"
...
read -p "Enter numbers separated by spaces: " choices
...
echo ""
echo -e "${GREEN}=========================================${NC}"
echo -e "${GREEN} DEBLOAT COMPLETED!${NC}"
echo -e "${GREEN}=========================================${NC}"
